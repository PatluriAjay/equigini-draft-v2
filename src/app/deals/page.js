...
export default function DealsPage() {
  ...
  return (
    <div className="flex gap-8 w-full px-10">
      {/* Left: Manage Deals */}
      {/* Center: Deals Table */}
      <div className="flex-1 rounded-2xl p-6 flex flex-col" style={{ border: "1px solid #e3e3e3" }}>
        {/* Header */}
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-2xl font-bold text-black">Deals</h2>
          <Link className="bg-lavender text-white px-6 py-2 rounded-lg font-semibold shadow hover:scale-105 transition-transform" href="/create-deal">Create Deal</Link>
        </div>
